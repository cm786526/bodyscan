    ...
    def get_analyze_list(self):
        ...
        for item in all_records:
            ...
            record_dict={
                ...
                "status":item.status,
                "feedback_file_name":"/filedownload?action=get_feedback_pdf&filename="+file_name,
                "upload_file_name":"/filedownload?action=get_upload_file&filename="+item.file_name
            }
